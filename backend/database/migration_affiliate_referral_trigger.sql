-- ============================================================
-- Migration: Affiliate Referral Trigger
-- Version: 1.0
-- Date: 24 December 2024
-- 
-- CRITICAL FIX: Process affiliate referrals during user signup.
-- 
-- The original handle_new_user trigger did not process affiliate
-- data from raw_user_meta_data, meaning referrals were never recorded.
-- 
-- This migration adds:
-- 1. A function to process affiliate referrals
-- 2. Updates handle_new_user to call this function
-- ============================================================

-- ============================================================
-- 1. FUNCTION: Process Affiliate Referral
-- ============================================================
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM affiliates WHERE id = v_affiliate_id AND user_id = p_user_id) THEN
...
-- ============================================================
-- 2. UPDATE: handle_new_user to process affiliate data
-- ============================================================
...
BEGIN
    ...
    -- =========================================================
    -- AFFILIATE REFERRAL PROCESSING (NEW!)
    -- =========================================================
...
-- SELECT process_affiliate_referral(gen_random_uuid(), 'test@test.com', gen_random_uuid(), 'INVALID_CODE', NULL);
-- Should return NULL and log a warning

-- Verify handle_new_user processes affiliate data:
-- Check that NEW.raw_user_meta_data->>'affiliate_code' is extracted
-- ============================================================
